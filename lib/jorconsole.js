...
var Terminal = jormodule('master/dev/terminal');
var TerminalInput = jormodule('master/dev/terminal-input');
var Framebuffer = jormodule('master/dev/framebuffer');
var Ethernet = jormodule('master/dev/ethernet');
var LoopSoundBuffer = jormodule('master/dev/sound');
var Filesystem = jormodule('master/dev/filesystem');
